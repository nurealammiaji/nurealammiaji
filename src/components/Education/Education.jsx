        ...
        <div id="education">
            ...
            <div className="items-center justify-center [&>*]:my-5 md:[&>*]:my-0 md:flex">
                <div className="p-4 m-2 text-left shadow shadow-secondary rounded-xl bg-neutral">
                    ...
                    <p className="mt-4 text-xl font-medium">Azteca University (International Programs)</p>
                    <p className="mt-3 text-slate-400">Chalco, Mexico</p>
                </div>
                <div className="p-4 m-2 text-left shadow shadow-secondary rounded-xl bg-neutral md:min-w-[300px]">
